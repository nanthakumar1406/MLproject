...
@st.cache_data
def load_data():
    # Replace with your actual file path or provide file uploader
    try:
...
# ... [previous code remains the same until the trend visualization] ...
...
if 'Built Year' in df.columns:
    ...
    # Add additional metrics (unchanged)
